...
For OAuth learning notes, summarize authorization code, access token, refresh token, scopes, and common mistakes, then use a third-party login scenario to check whether the distinctions are clear.
