...
For an operations login story, produce acceptance criteria for login success, wrong password, disabled account, session timeout, and access control with concrete test examples.
