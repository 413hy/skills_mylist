...
# User Story From Existing Materials
...
- User provides notes, meeting minutes, ticket text, or rough requirements.
- User asks for a User Story, acceptance criteria, or QA-ready story.
- A story needs to be generated from incomplete material.
