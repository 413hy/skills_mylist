...
For a web repository, infer frontend, backend, test, and docs areas from the tree, then sample package files, route files, and README before recommending where to read first.
