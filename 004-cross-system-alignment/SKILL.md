...
- User suspects code, requirements, or task state are inconsistent.
- Delivery needs confirmation that implementation covers acceptance criteria.
- Multiple documents or systems disagree about status or behavior.
