...
If the requirement says lock after 5 failed logins but code only shows an error and Jira is Done, use a test account to attempt five failed logins and verify whether the account locks before recommending fixes.
