...
For login redirects to the wrong page, inspect route guards, login form, session storage, and backend response before editing; then test protected-page redirect, successful login return path, refresh persistence, logout, and protected access after logout.
