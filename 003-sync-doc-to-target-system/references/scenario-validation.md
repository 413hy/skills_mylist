...
After syncing a login User Story into Jira, read the created issue and verify title, description, acceptance criteria, priority, assignee, status, labels, links, and attachments match the source.
