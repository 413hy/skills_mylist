...
# Sync Document To Target System
...
- User asks to sync a document, card, story, or task to another system.
- User needs fields, links, status, owners, or attachments preserved.
- A source and target system must be reconciled after sync.
