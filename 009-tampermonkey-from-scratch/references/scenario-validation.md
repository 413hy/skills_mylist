...
For a script that fills an admin login page, test on the actual login page with a reserved account. Verify fields fill, submit state is correct, wrong-page behavior is safe, and the script does not repeat after login.
