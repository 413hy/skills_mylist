...
For a user who does not know how to check git status, tell them to run git status in the repository and ask them to paste the full output, instead of explaining every git command at once.
