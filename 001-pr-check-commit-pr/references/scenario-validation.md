...
For a new login module, use a reserved test account through the browser login page. Verify successful login, wrong password handling, session persistence after refresh, logout, and protected-route access before committing.
