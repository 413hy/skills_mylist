...
For Cookie, Session, and JWT, ask how the server recognizes a second request from the same user, then use the answer to build the distinction between browser storage, server-side session state, and signed tokens.
