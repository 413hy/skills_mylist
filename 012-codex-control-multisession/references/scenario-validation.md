...
For an admin system split into login, orders, and reports sessions, require the login session to reserve a test account and validate login, wrong password, session persistence, logout, and protected-page access before reporting done.
