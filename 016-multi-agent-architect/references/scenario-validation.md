...
For a support-ticket system, simulate cannot log in and order is missing to test classification, account-agent routing, order-agent routing, shared context, conflict handling, and final customer response.
