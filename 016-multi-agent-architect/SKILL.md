...
- User asks for a multi-agent architecture.
- A task may require specialized agents with separate tools or responsibilities.
- Agent collaboration, routing, or orchestration needs design.
