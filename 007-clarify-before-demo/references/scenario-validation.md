...
For an admin demo with login, reserve a test account and validate login success, wrong password, session persistence, logout, protected page redirect, and the main admin workflow through the browser.
